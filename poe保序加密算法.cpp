...
int main()
{
    ...
    ans = (long long)1 << 62;
    KD_query(1, n, 0);
    double ans2=(xx-(0.000001*point[ansid].x[0]))*(xx-(0.000001*point[ansid].x[0]))+(yy-(0.000001*point[ansid].x[1]))*(yy-(0.000001*point[ansid].x[1]));
    cout<<"最近邻:"<<endl;
    cout<<(0.000001*point[ansid].x[0])<<" "<<(0.000001*point[ansid].x[1])<<" "<<(double)ans2<<endl;
    system("pause");
    return 0;
}